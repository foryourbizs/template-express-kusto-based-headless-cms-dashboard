 ...
 * List 컴포넌트로 등록되어 자동으로 라우팅과 메뉴가 생성됨
 * form control 대신 일반 state 사용
 */
export const Settings: React.FC = () => {
  ...
  return (
    <Box>
      ...
      {/* React Admin 방식으로 액션 버튼을 TopToolbar로 이동했으므로 여기서는 제거 */}
      </Box>
    </Box>
  );
};
