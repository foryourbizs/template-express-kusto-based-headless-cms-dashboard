...
export const GenericList = ({
  ...
  const mergedListProps: Partial<ListProps> = {
    ...
    filterDefaultValues: (filters.length > 0 && Object.keys(filterDefaultValues).length > 0) ? filterDefaultValues : undefined,
    sx: defaultListSx,
    empty,
    actions,
    title: hasTitle ? title : false,
    storeKey: storeKey !== undefined ? storeKey : undefined,
